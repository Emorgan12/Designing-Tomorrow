...
const ANIMAL_DATA = {
  penguin: {
    ...
    quiz: {
      question: ["Why are emperor penguins in danger of extinction?", "What can we do to help save emperor penguins?"],
      options: [
        ...
        [
          { text: "Use less energy and support charities fighting climate change", letter: "A" },
          { text: "Hunt the animals that are hunting them", letter: "B" },
          { text: "Build them a new home", letter: "C" },
          { text: "Nothing, they will be fine", letter: "D" },
        ]
      ],
      answer: ["B", "A"]
    },
  ...
  tiger: {
    ...
    quiz: {
    question: ["How can we protect Bengal tigers?", "How many Bengal tigers are left in the world?"],
      options: [
        ...
        [
          { text: "Less than 2,500", letter: "A" },
          { text: "About 10,000", letter: "B" },
          { text: "About 100,000", letter: "C" },
          { text: "More than 1 million", letter: "D" },
        ]
  ...
  elephant: {
    ...
    quiz: {
      question: ["What are savannah elephants and other elephant species hunted for?", "When were savannah elephants officially listed as endangered?"],
      options: [
